...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (eu.jdrabner.mtgDownloader.DownloaderMain)) {
...
@:keep class DocumentClass extends eu.jdrabner.mtgDownloader.DownloaderMain {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MTG Downloader", null, { width: 1280, height: 800 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (eu.jdrabner.mtgDownloader.DownloaderMain, []);
			}
